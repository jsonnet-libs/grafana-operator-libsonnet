  ...
  spec: {
    ...
    rules: {
      ...
      data: {
        ...
        '#withQueryType':: d.fn(help='"QueryType is an optional identifier for the type of query. It can be used to distinguish different types of queries."', args=[d.arg(name='queryType', type=d.T.string)]),
    ...
    '#withFolderUID':: d.fn(help='"UID of the folder containing this rule group Overrides the FolderSelector"', args=[d.arg(name='folderUID', type=d.T.string)]),
