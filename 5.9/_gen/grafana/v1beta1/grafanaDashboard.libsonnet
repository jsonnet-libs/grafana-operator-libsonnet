{
  ...
  '#':: d.pkg(name='grafanaDashboard', url='', help=''),
  ...
  spec: {
    ...
    '#withContentCacheDuration':: d.fn(help='', args=[d.arg(name='contentCacheDuration', type=d.T.string)]),
    ...
    '#withGzipJson':: d.fn(help='', args=[d.arg(name='gzipJson', type=d.T.string)]),
    withGzipJson(gzipJson): { spec+: { gzipJson: gzipJson } },
    '#withJson':: d.fn(help='', args=[d.arg(name='json', type=d.T.string)]),
