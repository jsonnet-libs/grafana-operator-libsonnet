{
  ...
  '#':: d.pkg(name='grafanaNotificationTemplate', url='', help='"GrafanaNotificationTemplate is the Schema for the GrafanaNotificationTemplate API"'),
  ...
  '#new':: d.fn(help='new returns an instance of GrafanaNotificationTemplate', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'grafana.integreatly.org/v1beta1',
    kind: 'GrafanaNotificationTemplate',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"GrafanaNotificationTemplateSpec defines the desired state of GrafanaNotificationTemplate"'),
  spec: {
    ...
    '#withEditable':: d.fn(help='"Whether to enable or disable editing of the notification template in Grafana UI"', args=[d.arg(name='editable', type=d.T.boolean)]),
    withEditable(editable): { spec+: { editable: editable } },
    '#withName':: d.fn(help='"Template name"', args=[d.arg(name='name', type=d.T.string)]),
    ...
    '#withTemplate':: d.fn(help='"Template content"', args=[d.arg(name='template', type=d.T.string)]),
