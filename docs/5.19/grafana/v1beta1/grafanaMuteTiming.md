---
permalink: /5.19/grafana/v1beta1/grafanaMuteTiming/
---

# grafana.v1beta1.grafanaMuteTiming
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.time_intervals`](#obj-spectime_intervals)
    * [`fn withDays_of_month(days_of_month)`](#fn-spectime_intervalswithdays_of_month)
    * [`fn withDays_of_monthMixin(days_of_month)`](#fn-spectime_intervalswithdays_of_monthmixin)
    * [`fn withLocation(location)`](#fn-spectime_intervalswithlocation)
    * [`fn withMonths(months)`](#fn-spectime_intervalswithmonths)
    * [`fn withMonthsMixin(months)`](#fn-spectime_intervalswithmonthsmixin)
    * [`fn withTimes(times)`](#fn-spectime_intervalswithtimes)
    * [`fn withTimesMixin(times)`](#fn-spectime_intervalswithtimesmixin)
    * [`fn withWeekdays(weekdays)`](#fn-spectime_intervalswithweekdays)
    * [`fn withWeekdaysMixin(weekdays)`](#fn-spectime_intervalswithweekdaysmixin)
    * [`fn withYears(years)`](#fn-spectime_intervalswithyears)
    * [`fn withYearsMixin(years)`](#fn-spectime_intervalswithyearsmixin)
    * [`obj spec.time_intervals.times`](#obj-spectime_intervalstimes)
      * [`fn withEnd_time(end_time)`](#fn-spectime_intervalstimeswithend_time)
      * [`fn withStart_time(start_time)`](#fn-spectime_intervalstimeswithstart_time)
...
new returns an instance of GrafanaMuteTiming
...
### fn spec.time_intervals.withDays_of_month
...
### fn spec.time_intervals.withDays_of_monthMixin
...
### fn spec.time_intervals.withLocation
...
### fn spec.time_intervals.withMonths
...
### fn spec.time_intervals.withMonthsMixin
...
### fn spec.time_intervals.withTimes
...
### fn spec.time_intervals.withTimesMixin
...
### fn spec.time_intervals.withWeekdays
...
### fn spec.time_intervals.withWeekdaysMixin
...
### fn spec.time_intervals.withYears
...
### fn spec.time_intervals.withYearsMixin
...
## obj spec.time_intervals.times

"The time inclusive of the start and exclusive of the end time (in UTC if no location has been selected, otherwise local time)."

### fn spec.time_intervals.times.withEnd_time
...
### fn spec.time_intervals.times.withStart_time
