---
permalink: /5.22/grafana/v1beta1/grafanaServiceAccount/
---

# grafana.v1beta1.grafanaServiceAccount
...
* [`obj spec`](#obj-spec)
  * [`fn withInstanceName(instanceName)`](#fn-specwithinstancename)
  * [`fn withIsDisabled(isDisabled)`](#fn-specwithisdisabled)
  ...
  * [`fn withTokens(tokens)`](#fn-specwithtokens)
  * [`fn withTokensMixin(tokens)`](#fn-specwithtokensmixin)
  * [`obj spec.tokens`](#obj-spectokens)
    * [`fn withExpires(expires)`](#fn-spectokenswithexpires)
    * [`fn withName(name)`](#fn-spectokenswithname)
    * [`fn withSecretName(secretName)`](#fn-spectokenswithsecretname)
...
new returns an instance of GrafanaServiceAccount
