{
  ...
  '#':: d.pkg(name='grafanaManifest', url='', help='"GrafanaManifest is the Schema for the grafana manifests"'),
  ...
  '#new':: d.fn(help='new returns an instance of GrafanaManifest', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'grafana.integreatly.org/v1beta1',
    kind: 'GrafanaManifest',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"GrafanaManifestSpec defines the desired state of a GrafanaManifest"'),
  spec: {
    ...
    patch: {
      ...
      env: {
        ...
        valueFrom: {
          ...
          '#grafanaRef':: d.obj(help='"ObjectFieldSelector selects an APIVersioned field of an object."'),
          grafanaRef: {
            ...
            withApiVersion(apiVersion): { valueFrom+: { grafanaRef+: { apiVersion: apiVersion } } },
            ...
            withFieldPath(fieldPath): { valueFrom+: { grafanaRef+: { fieldPath: fieldPath } } },
          },
      ...
      withEnv(env): { spec+: { patch+: { env: if std.isArray(v=env) then env else [env] } } },
      '#withEnvMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='env', type=d.T.array)]),
      withEnvMixin(env): { spec+: { patch+: { env+: if std.isArray(v=env) then env else [env] } } },
      '#withScripts':: d.fn(help='', args=[d.arg(name='scripts', type=d.T.array)]),
      withScripts(scripts): { spec+: { patch+: { scripts: if std.isArray(v=scripts) then scripts else [scripts] } } },
      '#withScriptsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='scripts', type=d.T.array)]),
      withScriptsMixin(scripts): { spec+: { patch+: { scripts+: if std.isArray(v=scripts) then scripts else [scripts] } } },
    },
    '#template':: d.obj(help=''),
    template: {
      '#metadata':: d.obj(help='"RequiredObjectMeta contains only a [subset of the fields included in k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.27/#objectmeta-v1-meta).\\nIt requires `name` to be set"'),
      metadata: {
      ...
      '#withApiVersion':: d.fn(help='"APIVersion defines the versioned schema of this representation of an object."', args=[d.arg(name='apiVersion', type=d.T.string)]),
      withApiVersion(apiVersion): { spec+: { template+: { apiVersion: apiVersion } } },
      '#withKind':: d.fn(help='"Kind is a string value representing the REST resource this object represents."', args=[d.arg(name='kind', type=d.T.string)]),
      withKind(kind): { spec+: { template+: { kind: kind } } },
      '#withSpec':: d.fn(help='', args=[d.arg(name='spec', type=d.T.any)]),
      withSpec(spec): { spec+: { template+: { spec: spec } } },
    },
