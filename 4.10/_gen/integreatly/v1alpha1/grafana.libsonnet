  ...
  spec: {
    ...
    config: {
      ...
      'auth.generic_oauth': {
        ...
        withName(name): { spec+: { config+: { auth+: { generic_oauth+: { name: name } } } } },
        ...
        withTeam_ids(team_ids): { spec+: { config+: { auth+: { generic_oauth+: { team_ids: team_ids } } } } },
        '#withTeam_ids_attribute_path':: d.fn(help='', args=[d.arg(name='team_ids_attribute_path', type=d.T.string)]),
        withTeam_ids_attribute_path(team_ids_attribute_path): { spec+: { config+: { auth+: { generic_oauth+: { team_ids_attribute_path: team_ids_attribute_path } } } } },
        '#withTeams_url':: d.fn(help='', args=[d.arg(name='teams_url', type=d.T.string)]),
        withTeams_url(teams_url): { spec+: { config+: { auth+: { generic_oauth+: { teams_url: teams_url } } } } },
        ...
        '#withUse_pkce':: d.fn(help='', args=[d.arg(name='use_pkce', type=d.T.boolean)]),
        withUse_pkce(use_pkce): { spec+: { config+: { auth+: { generic_oauth+: { use_pkce: use_pkce } } } } },
      },
      ...
      'auth.gitlab': {
        '#withAllow_assign_grafana_admin':: d.fn(help='', args=[d.arg(name='allow_assign_grafana_admin', type=d.T.boolean)]),
        withAllow_assign_grafana_admin(allow_assign_grafana_admin): { spec+: { config+: { auth+: { gitlab+: { allow_assign_grafana_admin: allow_assign_grafana_admin } } } } },
        '#withAllow_sign_up':: d.fn(help='', args=[d.arg(name='allow_sign_up', type=d.T.boolean)]),
        ...
        '#withRole_attribute_path':: d.fn(help='', args=[d.arg(name='role_attribute_path', type=d.T.string)]),
        withRole_attribute_path(role_attribute_path): { spec+: { config+: { auth+: { gitlab+: { role_attribute_path: role_attribute_path } } } } },
        '#withRole_attribute_strict':: d.fn(help='', args=[d.arg(name='role_attribute_strict', type=d.T.boolean)]),
        withRole_attribute_strict(role_attribute_strict): { spec+: { config+: { auth+: { gitlab+: { role_attribute_strict: role_attribute_strict } } } } },
        '#withScopes':: d.fn(help='', args=[d.arg(name='scopes', type=d.T.string)]),
      ...
      'auth.jwt': {
        '#withAllow_assign_grafana_admin':: d.fn(help='', args=[d.arg(name='allow_assign_grafana_admin', type=d.T.boolean)]),
        withAllow_assign_grafana_admin(allow_assign_grafana_admin): { spec+: { config+: { auth+: { jwt+: { allow_assign_grafana_admin: allow_assign_grafana_admin } } } } },
        '#withAuto_sign_up':: d.fn(help='', args=[d.arg(name='auto_sign_up', type=d.T.boolean)]),
        withAuto_sign_up(auto_sign_up): { spec+: { config+: { auth+: { jwt+: { auto_sign_up: auto_sign_up } } } } },
        '#withCache_ttl':: d.fn(help='', args=[d.arg(name='cache_ttl', type=d.T.string)]),
        withCache_ttl(cache_ttl): { spec+: { config+: { auth+: { jwt+: { cache_ttl: cache_ttl } } } } },
        '#withEmail_claim':: d.fn(help='', args=[d.arg(name='email_claim', type=d.T.string)]),
        withEmail_claim(email_claim): { spec+: { config+: { auth+: { jwt+: { email_claim: email_claim } } } } },
        '#withEnable_login_token':: d.fn(help='', args=[d.arg(name='enable_login_token', type=d.T.boolean)]),
        withEnable_login_token(enable_login_token): { spec+: { config+: { auth+: { jwt+: { enable_login_token: enable_login_token } } } } },
        '#withEnabled':: d.fn(help='', args=[d.arg(name='enabled', type=d.T.boolean)]),
        withEnabled(enabled): { spec+: { config+: { auth+: { jwt+: { enabled: enabled } } } } },
        '#withExpect_claims':: d.fn(help='', args=[d.arg(name='expect_claims', type=d.T.string)]),
        withExpect_claims(expect_claims): { spec+: { config+: { auth+: { jwt+: { expect_claims: expect_claims } } } } },
        '#withHeader_name':: d.fn(help='', args=[d.arg(name='header_name', type=d.T.string)]),
        withHeader_name(header_name): { spec+: { config+: { auth+: { jwt+: { header_name: header_name } } } } },
        '#withJwk_set_file':: d.fn(help='', args=[d.arg(name='jwk_set_file', type=d.T.string)]),
        withJwk_set_file(jwk_set_file): { spec+: { config+: { auth+: { jwt+: { jwk_set_file: jwk_set_file } } } } },
        '#withJwk_set_url':: d.fn(help='', args=[d.arg(name='jwk_set_url', type=d.T.string)]),
        withJwk_set_url(jwk_set_url): { spec+: { config+: { auth+: { jwt+: { jwk_set_url: jwk_set_url } } } } },
        '#withKey_file':: d.fn(help='', args=[d.arg(name='key_file', type=d.T.string)]),
        withKey_file(key_file): { spec+: { config+: { auth+: { jwt+: { key_file: key_file } } } } },
        '#withRole_attribute_path':: d.fn(help='', args=[d.arg(name='role_attribute_path', type=d.T.string)]),
        withRole_attribute_path(role_attribute_path): { spec+: { config+: { auth+: { jwt+: { role_attribute_path: role_attribute_path } } } } },
        '#withRole_attribute_strict':: d.fn(help='', args=[d.arg(name='role_attribute_strict', type=d.T.boolean)]),
        withRole_attribute_strict(role_attribute_strict): { spec+: { config+: { auth+: { jwt+: { role_attribute_strict: role_attribute_strict } } } } },
        '#withSkip_org_role_sync':: d.fn(help='', args=[d.arg(name='skip_org_role_sync', type=d.T.boolean)]),
        withSkip_org_role_sync(skip_org_role_sync): { spec+: { config+: { auth+: { jwt+: { skip_org_role_sync: skip_org_role_sync } } } } },
        '#withUrl_login':: d.fn(help='', args=[d.arg(name='url_login', type=d.T.boolean)]),
        withUrl_login(url_login): { spec+: { config+: { auth+: { jwt+: { url_login: url_login } } } } },
        '#withUsername_claim':: d.fn(help='', args=[d.arg(name='username_claim', type=d.T.string)]),
        withUsername_claim(username_claim): { spec+: { config+: { auth+: { jwt+: { username_claim: username_claim } } } } },
      },
      ...
      dashboards: {
        ...
        '#withMin_refresh_interval':: d.fn(help='"Prevents users from setting the dashboard refresh interval to a lower value than a given interval value"', args=[d.arg(name='min_refresh_interval', type=d.T.string)]),
        withMin_refresh_interval(min_refresh_interval): { spec+: { config+: { dashboards+: { min_refresh_interval: min_refresh_interval } } } },
      ...
      dataproxy: {
        '#withDialTimeout':: d.fn(help='', args=[d.arg(name='dialTimeout', type=d.T.integer)]),
        withDialTimeout(dialTimeout): { spec+: { config+: { dataproxy+: { dialTimeout: dialTimeout } } } },
        '#withExpect_continue_timeout_seconds':: d.fn(help='', args=[d.arg(name='expect_continue_timeout_seconds', type=d.T.integer)]),
        withExpect_continue_timeout_seconds(expect_continue_timeout_seconds): { spec+: { config+: { dataproxy+: { expect_continue_timeout_seconds: expect_continue_timeout_seconds } } } },
        '#withIdle_conn_timeout_seconds':: d.fn(help='', args=[d.arg(name='idle_conn_timeout_seconds', type=d.T.integer)]),
        withIdle_conn_timeout_seconds(idle_conn_timeout_seconds): { spec+: { config+: { dataproxy+: { idle_conn_timeout_seconds: idle_conn_timeout_seconds } } } },
        '#withKeep_alive_seconds':: d.fn(help='', args=[d.arg(name='keep_alive_seconds', type=d.T.integer)]),
        withKeep_alive_seconds(keep_alive_seconds): { spec+: { config+: { dataproxy+: { keep_alive_seconds: keep_alive_seconds } } } },
        '#withLogging':: d.fn(help='', args=[d.arg(name='logging', type=d.T.boolean)]),
        withLogging(logging): { spec+: { config+: { dataproxy+: { logging: logging } } } },
        '#withMax_conns_per_host':: d.fn(help='', args=[d.arg(name='max_conns_per_host', type=d.T.integer)]),
        withMax_conns_per_host(max_conns_per_host): { spec+: { config+: { dataproxy+: { max_conns_per_host: max_conns_per_host } } } },
        '#withMax_idle_connections':: d.fn(help='', args=[d.arg(name='max_idle_connections', type=d.T.integer)]),
        withMax_idle_connections(max_idle_connections): { spec+: { config+: { dataproxy+: { max_idle_connections: max_idle_connections } } } },
        '#withResponse_limit':: d.fn(help='', args=[d.arg(name='response_limit', type=d.T.integer)]),
        withResponse_limit(response_limit): { spec+: { config+: { dataproxy+: { response_limit: response_limit } } } },
        '#withRow_limit':: d.fn(help='', args=[d.arg(name='row_limit', type=d.T.integer)]),
        withRow_limit(row_limit): { spec+: { config+: { dataproxy+: { row_limit: row_limit } } } },
        ...
        '#withTls_handshake_timeout_seconds':: d.fn(help='', args=[d.arg(name='tls_handshake_timeout_seconds', type=d.T.integer)]),
        withTls_handshake_timeout_seconds(tls_handshake_timeout_seconds): { spec+: { config+: { dataproxy+: { tls_handshake_timeout_seconds: tls_handshake_timeout_seconds } } } },
      },
      ...
      '#plugins':: d.obj(help=''),
      plugins: {
        '#withAllow_loading_unsigned_plugins':: d.fn(help='"Enter a comma-separated list of plugin identifiers to identify plugins to load even if they are unsigned. Plugins with modified signatures are never loaded. We do not recommend using this option. For more information, refer to https://grafana.com/docs/grafana/next/administration/plugin-management/#plugin-signatures"', args=[d.arg(name='allow_loading_unsigned_plugins', type=d.T.string)]),
        withAllow_loading_unsigned_plugins(allow_loading_unsigned_plugins): { spec+: { config+: { plugins+: { allow_loading_unsigned_plugins: allow_loading_unsigned_plugins } } } },
        '#withEnable_alpha':: d.fn(help='"Set to true if you want to test alpha plugins that are not yet ready for general usage. Default is false."', args=[d.arg(name='enable_alpha', type=d.T.boolean)]),
        withEnable_alpha(enable_alpha): { spec+: { config+: { plugins+: { enable_alpha: enable_alpha } } } },
        '#withPlugin_admin_enabled':: d.fn(help='"Available to Grafana administrators only, enables installing / uninstalling / updating plugins directly from the Grafana UI. Set to true by default. Setting it to false will hide the install / uninstall / update controls. For more information, refer to https://grafana.com/docs/grafana/next/administration/plugin-management/#plugin-catalog"', args=[d.arg(name='plugin_admin_enabled', type=d.T.boolean)]),
        withPlugin_admin_enabled(plugin_admin_enabled): { spec+: { config+: { plugins+: { plugin_admin_enabled: plugin_admin_enabled } } } },
        '#withPlugin_catalog_hidden_plugins':: d.fn(help='"Enter a comma-separated list of plugin identifiers to hide in the plugin catalog."', args=[d.arg(name='plugin_catalog_hidden_plugins', type=d.T.string)]),
        withPlugin_catalog_hidden_plugins(plugin_catalog_hidden_plugins): { spec+: { config+: { plugins+: { plugin_catalog_hidden_plugins: plugin_catalog_hidden_plugins } } } },
        '#withPlugin_catalog_url':: d.fn(help='"Custom install/learn more URL for enterprise plugins. Defaults to https://grafana.com/grafana/plugins/."', args=[d.arg(name='plugin_catalog_url', type=d.T.string)]),
        withPlugin_catalog_url(plugin_catalog_url): { spec+: { config+: { plugins+: { plugin_catalog_url: plugin_catalog_url } } } },
      },
    ...
    '#dashboardLabelSelector':: d.obj(help=''),
    ...
    dataStorage: {
      ...
      withVolumeName(volumeName): { spec+: { dataStorage+: { volumeName: volumeName } } },
    },
    ...
    deployment: {
      ...
      containerSecurityContext: {
        ...
        windowsOptions: {
          ...
          '#withHostProcess':: d.fn(help="\"HostProcess determines if a container should be run as a 'Host Process' container. This field is alpha-level and will only be honored by components that enable the WindowsHostProcessContainers feature flag. Setting this field without the feature flag will result in errors when validating the Pod. All of a Pod's containers must have the same effective HostProcess value (it is not allowed to have a mix of HostProcess containers and non-HostProcess containers).  In addition, if HostProcess is true then HostNetwork must also be set to true.\"", args=[d.arg(name='hostProcess', type=d.T.boolean)]),
          withHostProcess(hostProcess): { spec+: { deployment+: { containerSecurityContext+: { windowsOptions+: { hostProcess: hostProcess } } } } },
          '#withRunAsUserName':: d.fn(help='"The UserName in Windows to run the entrypoint of the container process. Defaults to the user specified in image metadata if unspecified. May also be set in PodSecurityContext. If set in both SecurityContext and PodSecurityContext, the value specified in SecurityContext takes precedence."', args=[d.arg(name='runAsUserName', type=d.T.string)]),
      ...
      httpProxy: {
        ...
        '#withNoProxy':: d.fn(help='', args=[d.arg(name='noProxy', type=d.T.string)]),
        withNoProxy(noProxy): { spec+: { deployment+: { httpProxy+: { noProxy: noProxy } } } },
      ...
      securityContext: {
        ...
        windowsOptions: {
          ...
          '#withHostProcess':: d.fn(help="\"HostProcess determines if a container should be run as a 'Host Process' container. This field is alpha-level and will only be honored by components that enable the WindowsHostProcessContainers feature flag. Setting this field without the feature flag will result in errors when validating the Pod. All of a Pod's containers must have the same effective HostProcess value (it is not allowed to have a mix of HostProcess containers and non-HostProcess containers).  In addition, if HostProcess is true then HostNetwork must also be set to true.\"", args=[d.arg(name='hostProcess', type=d.T.boolean)]),
          withHostProcess(hostProcess): { spec+: { deployment+: { securityContext+: { windowsOptions+: { hostProcess: hostProcess } } } } },
          '#withRunAsUserName':: d.fn(help='"The UserName in Windows to run the entrypoint of the container process. Defaults to the user specified in image metadata if unspecified. May also be set in PodSecurityContext. If set in both SecurityContext and PodSecurityContext, the value specified in SecurityContext takes precedence."', args=[d.arg(name='runAsUserName', type=d.T.string)]),
      ...
      withTopologySpreadConstraints(topologySpreadConstraints): { spec+: { deployment+: { topologySpreadConstraints: if std.isArray(v=topologySpreadConstraints) then topologySpreadConstraints else [topologySpreadConstraints] } } },
      ...
      withTopologySpreadConstraintsMixin(topologySpreadConstraints): { spec+: { deployment+: { topologySpreadConstraints+: if std.isArray(v=topologySpreadConstraints) then topologySpreadConstraints else [topologySpreadConstraints] } } },
    },
    ...
    livenessProbeSpec: {
      ...
      '#withScheme':: d.fn(help='"URIScheme identifies the scheme used for connection to a host for Get actions. Deprecated in favor of config.server.protocol."', args=[d.arg(name='scheme', type=d.T.string)]),
    ...
    '#withDashboardContentCacheDuration':: d.fn(help="\"DashboardContentCacheDuration sets a default for when a `GrafanaDashboard` resource doesn't specify a `contentCacheDuration`. If left unset or 0 the default behavior is to cache indefinitely.\"", args=[d.arg(name='dashboardContentCacheDuration', type=d.T.string)]),
    withDashboardContentCacheDuration(dashboardContentCacheDuration): { spec+: { dashboardContentCacheDuration: dashboardContentCacheDuration } },
