---
permalink: /4.10/integreatly/v1alpha1/grafana/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.deployment`](#obj-specdeployment)
    ...
    * [`obj spec.deployment.httpProxy`](#obj-specdeploymenthttpproxy)
      ...
      * [`fn withNoProxy(noProxy)`](#fn-specdeploymenthttpproxywithnoproxy)
    ...
    * [`obj spec.deployment.securityContext`](#obj-specdeploymentsecuritycontext)
      ...
      * [`obj spec.deployment.securityContext.windowsOptions`](#obj-specdeploymentsecuritycontextwindowsoptions)
        ...
        * [`fn withHostProcess(hostProcess)`](#fn-specdeploymentsecuritycontextwindowsoptionswithhostprocess)
    ...
    * [`obj spec.deployment.topologySpreadConstraints`](#obj-specdeploymenttopologyspreadconstraints)
      * [`fn withMaxSkew(maxSkew)`](#fn-specdeploymenttopologyspreadconstraintswithmaxskew)
      * [`fn withMinDomains(minDomains)`](#fn-specdeploymenttopologyspreadconstraintswithmindomains)
      * [`fn withTopologyKey(topologyKey)`](#fn-specdeploymenttopologyspreadconstraintswithtopologykey)
      * [`fn withWhenUnsatisfiable(whenUnsatisfiable)`](#fn-specdeploymenttopologyspreadconstraintswithwhenunsatisfiable)
      * [`obj spec.deployment.topologySpreadConstraints.labelSelector`](#obj-specdeploymenttopologyspreadconstraintslabelselector)
        * [`fn withMatchExpressions(matchExpressions)`](#fn-specdeploymenttopologyspreadconstraintslabelselectorwithmatchexpressions)
        * [`fn withMatchExpressionsMixin(matchExpressions)`](#fn-specdeploymenttopologyspreadconstraintslabelselectorwithmatchexpressionsmixin)
        * [`fn withMatchLabels(matchLabels)`](#fn-specdeploymenttopologyspreadconstraintslabelselectorwithmatchlabels)
        * [`fn withMatchLabelsMixin(matchLabels)`](#fn-specdeploymenttopologyspreadconstraintslabelselectorwithmatchlabelsmixin)
        * [`obj spec.deployment.topologySpreadConstraints.labelSelector.matchExpressions`](#obj-specdeploymenttopologyspreadconstraintslabelselectormatchexpressions)
          * [`fn withKey(key)`](#fn-specdeploymenttopologyspreadconstraintslabelselectormatchexpressionswithkey)
          * [`fn withOperator(operator)`](#fn-specdeploymenttopologyspreadconstraintslabelselectormatchexpressionswithoperator)
          * [`fn withValues(values)`](#fn-specdeploymenttopologyspreadconstraintslabelselectormatchexpressionswithvalues)
          * [`fn withValuesMixin(values)`](#fn-specdeploymenttopologyspreadconstraintslabelselectormatchexpressionswithvaluesmixin)
...
### fn spec.withDashboardContentCacheDuration

```ts
withDashboardContentCacheDuration(dashboardContentCacheDuration)
```
...
### fn spec.config.auth.generic_oauth.withName
...
### fn spec.config.auth.generic_oauth.withTeam_ids
...
### fn spec.config.auth.generic_oauth.withTeam_ids_attribute_path

```ts
withTeam_ids_attribute_path(team_ids_attribute_path)
```



### fn spec.config.auth.generic_oauth.withTeams_url

```ts
withTeams_url(teams_url)
```
...
### fn spec.config.auth.generic_oauth.withUse_pkce

```ts
withUse_pkce(use_pkce)
```
...
### fn spec.config.auth.gitlab.withAllow_assign_grafana_admin

```ts
withAllow_assign_grafana_admin(allow_assign_grafana_admin)
```
...
### fn spec.config.auth.gitlab.withRole_attribute_path
...
### fn spec.config.auth.gitlab.withRole_attribute_strict
...
## obj spec.config.auth.jwt



### fn spec.config.auth.jwt.withAllow_assign_grafana_admin
...
### fn spec.config.auth.jwt.withAuto_sign_up
...
### fn spec.config.auth.jwt.withCache_ttl
...
### fn spec.config.auth.jwt.withEmail_claim

```ts
withEmail_claim(email_claim)
```



### fn spec.config.auth.jwt.withEnable_login_token
...
### fn spec.config.auth.jwt.withEnabled
...
### fn spec.config.auth.jwt.withExpect_claims

```ts
withExpect_claims(expect_claims)
```



### fn spec.config.auth.jwt.withHeader_name
...
### fn spec.config.auth.jwt.withJwk_set_file

```ts
withJwk_set_file(jwk_set_file)
```



### fn spec.config.auth.jwt.withJwk_set_url

```ts
withJwk_set_url(jwk_set_url)
```



### fn spec.config.auth.jwt.withKey_file
...
### fn spec.config.auth.jwt.withRole_attribute_path
...
### fn spec.config.auth.jwt.withRole_attribute_strict
...
### fn spec.config.auth.jwt.withSkip_org_role_sync

```ts
withSkip_org_role_sync(skip_org_role_sync)
```



### fn spec.config.auth.jwt.withUrl_login

```ts
withUrl_login(url_login)
```



### fn spec.config.auth.jwt.withUsername_claim
...
### fn spec.config.dashboards.withMin_refresh_interval

```ts
withMin_refresh_interval(min_refresh_interval)
```
...
### fn spec.config.dataproxy.withDialTimeout
...
### fn spec.config.dataproxy.withExpect_continue_timeout_seconds

```ts
withExpect_continue_timeout_seconds(expect_continue_timeout_seconds)
```



### fn spec.config.dataproxy.withIdle_conn_timeout_seconds

```ts
withIdle_conn_timeout_seconds(idle_conn_timeout_seconds)
```



### fn spec.config.dataproxy.withKeep_alive_seconds

```ts
withKeep_alive_seconds(keep_alive_seconds)
```
...
### fn spec.config.dataproxy.withMax_conns_per_host

```ts
withMax_conns_per_host(max_conns_per_host)
```



### fn spec.config.dataproxy.withMax_idle_connections

```ts
withMax_idle_connections(max_idle_connections)
```



### fn spec.config.dataproxy.withResponse_limit

```ts
withResponse_limit(response_limit)
```



### fn spec.config.dataproxy.withRow_limit

```ts
withRow_limit(row_limit)
```
...
### fn spec.config.dataproxy.withTls_handshake_timeout_seconds

```ts
withTls_handshake_timeout_seconds(tls_handshake_timeout_seconds)
```
...
### fn spec.config.plugins.withAllow_loading_unsigned_plugins

```ts
withAllow_loading_unsigned_plugins(allow_loading_unsigned_plugins)
```
...
### fn spec.config.plugins.withPlugin_admin_enabled

```ts
withPlugin_admin_enabled(plugin_admin_enabled)
```
...
### fn spec.config.plugins.withPlugin_catalog_hidden_plugins

```ts
withPlugin_catalog_hidden_plugins(plugin_catalog_hidden_plugins)
```

"Enter a comma-separated list of plugin identifiers to hide in the plugin catalog."

### fn spec.config.plugins.withPlugin_catalog_url

```ts
withPlugin_catalog_url(plugin_catalog_url)
```
...
### fn spec.dataStorage.withVolumeName
...
### fn spec.deployment.withTopologySpreadConstraints
...
### fn spec.deployment.withTopologySpreadConstraintsMixin
...
### fn spec.deployment.containerSecurityContext.windowsOptions.withHostProcess
...
## obj spec.deployment.extraVolumes.ephemeral.volumeClaimTemplate.spec.dataSourceRef
...
### fn spec.deployment.extraVolumes.ephemeral.volumeClaimTemplate.spec.dataSourceRef.withApiGroup
...
### fn spec.deployment.extraVolumes.ephemeral.volumeClaimTemplate.spec.dataSourceRef.withKind
...
### fn spec.deployment.extraVolumes.ephemeral.volumeClaimTemplate.spec.dataSourceRef.withName
...
### fn spec.deployment.httpProxy.withNoProxy
...
### fn spec.deployment.securityContext.windowsOptions.withHostProcess
...
## obj spec.deployment.topologySpreadConstraints



### fn spec.deployment.topologySpreadConstraints.withMaxSkew
...
### fn spec.deployment.topologySpreadConstraints.withMinDomains
...
### fn spec.deployment.topologySpreadConstraints.withTopologyKey
...
### fn spec.deployment.topologySpreadConstraints.withWhenUnsatisfiable
...
## obj spec.deployment.topologySpreadConstraints.labelSelector

"LabelSelector is used to find matching pods. Pods that match this label selector are counted to determine the number of pods in their corresponding topology domain."

### fn spec.deployment.topologySpreadConstraints.labelSelector.withMatchExpressions
...
### fn spec.deployment.topologySpreadConstraints.labelSelector.withMatchExpressionsMixin
...
### fn spec.deployment.topologySpreadConstraints.labelSelector.withMatchLabels
...
### fn spec.deployment.topologySpreadConstraints.labelSelector.withMatchLabelsMixin
...
## obj spec.deployment.topologySpreadConstraints.labelSelector.matchExpressions

"matchExpressions is a list of label selector requirements. The requirements are ANDed."

### fn spec.deployment.topologySpreadConstraints.labelSelector.matchExpressions.withKey
...
### fn spec.deployment.topologySpreadConstraints.labelSelector.matchExpressions.withOperator
...
### fn spec.deployment.topologySpreadConstraints.labelSelector.matchExpressions.withValues
...
### fn spec.deployment.topologySpreadConstraints.labelSelector.matchExpressions.withValuesMixin
