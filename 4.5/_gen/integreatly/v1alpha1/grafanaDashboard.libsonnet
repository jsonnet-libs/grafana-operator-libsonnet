{
  ...
  spec: {
    '#configMapRef':: d.obj(help="\"ConfigMapRef is a reference to a ConfigMap data field containing the dashboard's JSON\""),
    configMapRef: {
    ...
    '#gzipConfigMapRef':: d.obj(help="\"GzipConfigMapRef is a reference to a ConfigMap binaryData field containing the dashboard's JSON, compressed with Gzip.\""),
    gzipConfigMapRef: {
      '#withKey':: d.fn(help='"The key to select."', args=[d.arg(name='key', type=d.T.string)]),
      withKey(key): { spec+: { gzipConfigMapRef+: { key: key } } },
      '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names TODO: Add other useful fields. apiVersion, kind, uid?"', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { gzipConfigMapRef+: { name: name } } },
      '#withOptional':: d.fn(help='"Specify whether the ConfigMap or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
      withOptional(optional): { spec+: { gzipConfigMapRef+: { optional: optional } } },
    },
    '#plugins':: d.obj(help=''),
    plugins: {
    ...
    '#withContentCacheDuration':: d.fn(help='"ContentCacheDuration sets how often the operator should resync with the external source when using the `grafanaCom.id` or `url` field to specify the source of the dashboard. The default value is decided by the `dashboardContentCacheDuration` field in the `Grafana` resource. The default is 0 which is interpreted as never refetching."', args=[d.arg(name='contentCacheDuration', type=d.T.string)]),
    withContentCacheDuration(contentCacheDuration): { spec+: { contentCacheDuration: contentCacheDuration } },
    '#withCustomFolderName':: d.fn(help='', args=[d.arg(name='customFolderName', type=d.T.string)]),
    withCustomFolderName(customFolderName): { spec+: { customFolderName: customFolderName } },
    ...
    '#withJson':: d.fn(help="\"Json is the dashboard's JSON\"", args=[d.arg(name='json', type=d.T.string)]),
    withJson(json): { spec+: { json: json } },
    '#withJsonnet':: d.fn(help='', args=[d.arg(name='jsonnet', type=d.T.string)]),
