---
permalink: /5.22/grafana/v1beta1/grafanaNotificationPolicy/
---

# grafana.v1beta1.grafanaNotificationPolicy
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.route`](#obj-specroute)
    ...
    * [`fn withMatch_re(match_re)`](#fn-specroutewithmatch_re)
    * [`fn withMatch_reMixin(match_re)`](#fn-specroutewithmatch_remixin)
    ...
    * [`fn withObject_matchers(object_matchers)`](#fn-specroutewithobject_matchers)
    * [`fn withObject_matchersMixin(object_matchers)`](#fn-specroutewithobject_matchersmixin)
    * [`fn withProvenance(provenance)`](#fn-specroutewithprovenance)
    ...
    * [`obj spec.route.matchers`](#obj-specroutematchers)
      * [`fn withIsEqual(isEqual)`](#fn-specroutematcherswithisequal)
      * [`fn withIsRegex(isRegex)`](#fn-specroutematcherswithisregex)
      * [`fn withName(name)`](#fn-specroutematcherswithname)
      * [`fn withValue(value)`](#fn-specroutematcherswithvalue)
    * [`obj spec.route.routeSelector`](#obj-specrouterouteselector)
      * [`fn withMatchExpressions(matchExpressions)`](#fn-specrouterouteselectorwithmatchexpressions)
      * [`fn withMatchExpressionsMixin(matchExpressions)`](#fn-specrouterouteselectorwithmatchexpressionsmixin)
      * [`fn withMatchLabels(matchLabels)`](#fn-specrouterouteselectorwithmatchlabels)
      * [`fn withMatchLabelsMixin(matchLabels)`](#fn-specrouterouteselectorwithmatchlabelsmixin)
      * [`obj spec.route.routeSelector.matchExpressions`](#obj-specrouterouteselectormatchexpressions)
        * [`fn withKey(key)`](#fn-specrouterouteselectormatchexpressionswithkey)
        * [`fn withOperator(operator)`](#fn-specrouterouteselectormatchexpressionswithoperator)
        * [`fn withValues(values)`](#fn-specrouterouteselectormatchexpressionswithvalues)
        * [`fn withValuesMixin(values)`](#fn-specrouterouteselectormatchexpressionswithvaluesmixin)
...
new returns an instance of GrafanaNotificationPolicy
...
### fn spec.route.withMatch_reMixin
...
### fn spec.route.withObject_matchers
...
### fn spec.route.withObject_matchersMixin
...
### fn spec.route.matchers.withIsEqual
...
### fn spec.route.matchers.withIsRegex
...
### fn spec.route.routeSelector.withMatchExpressionsMixin
...
### fn spec.route.routeSelector.withMatchLabels
...
### fn spec.route.routeSelector.withMatchLabelsMixin
...
## obj spec.route.routeSelector.matchExpressions

"matchExpressions is a list of label selector requirements. The requirements are ANDed."

### fn spec.route.routeSelector.matchExpressions.withKey
...
### fn spec.route.routeSelector.matchExpressions.withOperator
...
### fn spec.route.routeSelector.matchExpressions.withValues
...
### fn spec.route.routeSelector.matchExpressions.withValuesMixin
