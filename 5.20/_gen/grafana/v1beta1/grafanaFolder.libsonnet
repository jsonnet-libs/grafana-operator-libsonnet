{
  ...
  spec: {
    ...
    '#withUid':: d.fn(help='"Manually specify the UID the Folder is created with. Can be any string consisting of alphanumeric characters, - and _ with a maximum length of 40"', args=[d.arg(name='uid', type=d.T.string)]),
