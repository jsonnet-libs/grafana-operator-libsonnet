{
  ...
  '#':: d.pkg(name='grafanaFolder', url='', help='"GrafanaFolder is the Schema for the grafanafolders API"'),
  ...
  '#spec':: d.obj(help='"GrafanaFolderSpec defines the desired state of GrafanaFolder"'),
  spec: {
    ...
    '#withAllowCrossNamespaceImport':: d.fn(help='"Enable matching Grafana instances outside the current namespace"', args=[d.arg(name='allowCrossNamespaceImport', type=d.T.boolean)]),
    withAllowCrossNamespaceImport(allowCrossNamespaceImport): { spec+: { allowCrossNamespaceImport: allowCrossNamespaceImport } },
    '#withParentFolderRef':: d.fn(help='"Reference to an existing GrafanaFolder CR in the same namespace"', args=[d.arg(name='parentFolderRef', type=d.T.string)]),
    withParentFolderRef(parentFolderRef): { spec+: { parentFolderRef: parentFolderRef } },
    '#withParentFolderUID':: d.fn(help='"UID of the folder in which the current folder should be created"', args=[d.arg(name='parentFolderUID', type=d.T.string)]),
    withParentFolderUID(parentFolderUID): { spec+: { parentFolderUID: parentFolderUID } },
    '#withPermissions':: d.fn(help='"Raw json with folder permissions, potentially exported from Grafana"', args=[d.arg(name='permissions', type=d.T.string)]),
    withPermissions(permissions): { spec+: { permissions: permissions } },
    '#withResyncPeriod':: d.fn(help='"How often the folder is synced, defaults to 5m if not set"', args=[d.arg(name='resyncPeriod', type=d.T.string)]),
    withResyncPeriod(resyncPeriod): { spec+: { resyncPeriod: resyncPeriod } },
    '#withTitle':: d.fn(help='"Display name of the folder in Grafana"', args=[d.arg(name='title', type=d.T.string)]),
    withTitle(title): { spec+: { title: title } },
    '#withUid':: d.fn(help='"Manually specify the UID the Folder is created with"', args=[d.arg(name='uid', type=d.T.string)]),
