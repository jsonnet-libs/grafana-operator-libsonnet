---
permalink: /4.10/integreatly/v1alpha1/grafanaDashboard/
---

# integreatly.v1alpha1.grafanaDashboard
...
* [`obj spec`](#obj-spec)
  ...
  * [`fn withCustomFolderName(customFolderName)`](#fn-specwithcustomfoldername)
  ...
  * [`obj spec.gzipConfigMapRef`](#obj-specgzipconfigmapref)
    * [`fn withKey(key)`](#fn-specgzipconfigmaprefwithkey)
    * [`fn withName(name)`](#fn-specgzipconfigmaprefwithname)
    * [`fn withOptional(optional)`](#fn-specgzipconfigmaprefwithoptional)
...
### fn spec.withCustomFolderName

```ts
withCustomFolderName(customFolderName)
```
...
### fn spec.gzipConfigMapRef.withName
...
### fn spec.gzipConfigMapRef.withOptional
