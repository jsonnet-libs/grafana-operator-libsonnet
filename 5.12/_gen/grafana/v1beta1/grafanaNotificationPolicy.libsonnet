{
  ...
  spec: {
    ...
    route: {
      ...
      matchers: {
        '#withIsEqual':: d.fn(help='"is equal"', args=[d.arg(name='isEqual', type=d.T.boolean)]),
        withIsEqual(isEqual): { isEqual: isEqual },
        '#withIsRegex':: d.fn(help='"is regex"', args=[d.arg(name='isRegex', type=d.T.boolean)]),
      ...
      '#withProvenance':: d.fn(help='"provenance"', args=[d.arg(name='provenance', type=d.T.string)]),
      ...
      '#withRoutes':: d.fn(help='"routes"', args=[d.arg(name='routes', type=d.T.any)]),
