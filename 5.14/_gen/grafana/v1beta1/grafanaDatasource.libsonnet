{
  ...
  spec: {
    ...
    datasource: {
      ...
      '#withEditable':: d.fn(help='"Deprecated field, it has no effect"', args=[d.arg(name='editable', type=d.T.boolean)]),
    ...
    '#withResyncPeriod':: d.fn(help='"how often the datasource is refreshed, defaults to 5m if not set"', args=[d.arg(name='resyncPeriod', type=d.T.string)]),
