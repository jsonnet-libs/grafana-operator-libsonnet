---
permalink: /5.22/grafana/v1beta1/grafanaAlertRuleGroup/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.rules`](#obj-specrules)
    ...
    * [`fn withDashboardUid(dashboardUid)`](#fn-specruleswithdashboarduid)
    ...
    * [`fn withKeepFiringFor(keepFiringFor)`](#fn-specruleswithkeepfiringfor)
    * [`fn withLabels(labels)`](#fn-specruleswithlabels)
    * [`fn withLabelsMixin(labels)`](#fn-specruleswithlabelsmixin)
    * [`fn withMissingSeriesEvalsToResolve(missingSeriesEvalsToResolve)`](#fn-specruleswithmissingseriesevalstoresolve)
    * [`fn withNoDataState(noDataState)`](#fn-specruleswithnodatastate)
    * [`fn withPanelId(panelId)`](#fn-specruleswithpanelid)
    ...
    * [`obj spec.rules.notificationSettings`](#obj-specrulesnotificationsettings)
      * [`fn withActive_time_intervals(active_time_intervals)`](#fn-specrulesnotificationsettingswithactive_time_intervals)
      * [`fn withActive_time_intervalsMixin(active_time_intervals)`](#fn-specrulesnotificationsettingswithactive_time_intervalsmixin)
    ...
    * [`obj spec.rules.record`](#obj-specrulesrecord)
      * [`fn withFrom(from)`](#fn-specrulesrecordwithfrom)
      * [`fn withMetric(metric)`](#fn-specrulesrecordwithmetric)
      * [`fn withTargetDatasourceUid(targetDatasourceUid)`](#fn-specrulesrecordwithtargetdatasourceuid)
...
### fn spec.rules.withDashboardUid
...
### fn spec.rules.withKeepFiringFor
...
### fn spec.rules.withMissingSeriesEvalsToResolve
...
### fn spec.rules.notificationSettings.withActive_time_intervals
...
### fn spec.rules.notificationSettings.withActive_time_intervalsMixin
...
## obj spec.rules.record



### fn spec.rules.record.withFrom
...
### fn spec.rules.record.withMetric
...
### fn spec.rules.record.withTargetDatasourceUid
