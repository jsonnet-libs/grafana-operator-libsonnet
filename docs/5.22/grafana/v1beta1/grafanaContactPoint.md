---
permalink: /5.22/grafana/v1beta1/grafanaContactPoint/
---

# grafana.v1beta1.grafanaContactPoint
...
* [`obj spec`](#obj-spec)
  ...
  * [`fn withDisableResolveMessage(disableResolveMessage)`](#fn-specwithdisableresolvemessage)
  * [`fn withEditable(editable)`](#fn-specwitheditable)
  ...
  * [`fn withSettings(settings)`](#fn-specwithsettings)
  ...
  * [`obj spec.receivers`](#obj-specreceivers)
    * [`fn withDisableResolveMessage(disableResolveMessage)`](#fn-specreceiverswithdisableresolvemessage)
    * [`fn withSettings(settings)`](#fn-specreceiverswithsettings)
    * [`fn withType(type)`](#fn-specreceiverswithtype)
    * [`fn withUid(uid)`](#fn-specreceiverswithuid)
    * [`fn withValuesFrom(valuesFrom)`](#fn-specreceiverswithvaluesfrom)
    * [`fn withValuesFromMixin(valuesFrom)`](#fn-specreceiverswithvaluesfrommixin)
    * [`obj spec.receivers.valuesFrom`](#obj-specreceiversvaluesfrom)
      * [`fn withTargetPath(targetPath)`](#fn-specreceiversvaluesfromwithtargetpath)
      * [`obj spec.receivers.valuesFrom.valueFrom`](#obj-specreceiversvaluesfromvaluefrom)
        * [`obj spec.receivers.valuesFrom.valueFrom.configMapKeyRef`](#obj-specreceiversvaluesfromvaluefromconfigmapkeyref)
          * [`fn withKey(key)`](#fn-specreceiversvaluesfromvaluefromconfigmapkeyrefwithkey)
          * [`fn withName(name)`](#fn-specreceiversvaluesfromvaluefromconfigmapkeyrefwithname)
          * [`fn withOptional(optional)`](#fn-specreceiversvaluesfromvaluefromconfigmapkeyrefwithoptional)
        * [`obj spec.receivers.valuesFrom.valueFrom.secretKeyRef`](#obj-specreceiversvaluesfromvaluefromsecretkeyref)
          * [`fn withKey(key)`](#fn-specreceiversvaluesfromvaluefromsecretkeyrefwithkey)
          * [`fn withName(name)`](#fn-specreceiversvaluesfromvaluefromsecretkeyrefwithname)
          * [`fn withOptional(optional)`](#fn-specreceiversvaluesfromvaluefromsecretkeyrefwithoptional)
...
new returns an instance of GrafanaContactPoint
...
### fn spec.withDisableResolveMessage
...
### fn spec.receivers.withDisableResolveMessage
...
### fn spec.receivers.withSettings
...
### fn spec.receivers.withValuesFrom
...
### fn spec.receivers.withValuesFromMixin
...
## obj spec.receivers.valuesFrom



### fn spec.receivers.valuesFrom.withTargetPath
...
## obj spec.receivers.valuesFrom.valueFrom



## obj spec.receivers.valuesFrom.valueFrom.configMapKeyRef

"Selects a key of a ConfigMap."

### fn spec.receivers.valuesFrom.valueFrom.configMapKeyRef.withKey
...
### fn spec.receivers.valuesFrom.valueFrom.configMapKeyRef.withName
...
### fn spec.receivers.valuesFrom.valueFrom.configMapKeyRef.withOptional
...
## obj spec.receivers.valuesFrom.valueFrom.secretKeyRef

"Selects a key of a Secret."

### fn spec.receivers.valuesFrom.valueFrom.secretKeyRef.withKey
...
### fn spec.receivers.valuesFrom.valueFrom.secretKeyRef.withName
...
### fn spec.receivers.valuesFrom.valueFrom.secretKeyRef.withOptional
