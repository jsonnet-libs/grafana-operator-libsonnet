---
permalink: /5.11/grafana/v1beta1/grafanaFolder/
---

# grafana.v1beta1.grafanaFolder
...
* [`obj spec`](#obj-spec)
  ...
  * [`fn withParentFolderRef(parentFolderRef)`](#fn-specwithparentfolderref)
  * [`fn withParentFolderUID(parentFolderUID)`](#fn-specwithparentfolderuid)
...
### fn spec.withParentFolderRef

```ts
withParentFolderRef(parentFolderRef)
```

"Reference to an existing GrafanaFolder CR in the same namespace"

### fn spec.withParentFolderUID
