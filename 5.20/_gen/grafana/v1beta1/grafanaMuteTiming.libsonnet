{
  ...
  '#':: d.pkg(name='grafanaMuteTiming', url='', help='"GrafanaMuteTiming is the Schema for the GrafanaMuteTiming API"'),
  ...
  '#new':: d.fn(help='new returns an instance of GrafanaMuteTiming', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'grafana.integreatly.org/v1beta1',
    kind: 'GrafanaMuteTiming',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"GrafanaMuteTimingSpec defines the desired state of GrafanaMuteTiming"'),
  spec: {
    ...
    '#time_intervals':: d.obj(help='"Time intervals for muting"'),
    time_intervals: {
      '#times':: d.obj(help='"The time inclusive of the start and exclusive of the end time (in UTC if no location has been selected, otherwise local time)."'),
      times: {
        '#withEnd_time':: d.fn(help='"end time"', args=[d.arg(name='end_time', type=d.T.string)]),
        withEnd_time(end_time): { end_time: end_time },
        '#withStart_time':: d.fn(help='"start time"', args=[d.arg(name='start_time', type=d.T.string)]),
        withStart_time(start_time): { start_time: start_time },
      },
      '#withDays_of_month':: d.fn(help='"The date 1-31 of a month. Negative values can also be used to represent days that begin at the end of the month.\\nFor example: -1 for the last day of the month."', args=[d.arg(name='days_of_month', type=d.T.array)]),
      withDays_of_month(days_of_month): { days_of_month: if std.isArray(v=days_of_month) then days_of_month else [days_of_month] },
      '#withDays_of_monthMixin':: d.fn(help='"The date 1-31 of a month. Negative values can also be used to represent days that begin at the end of the month.\\nFor example: -1 for the last day of the month."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='days_of_month', type=d.T.array)]),
      withDays_of_monthMixin(days_of_month): { days_of_month+: if std.isArray(v=days_of_month) then days_of_month else [days_of_month] },
      '#withLocation':: d.fn(help='"Depending on the location, the time range is displayed in local time."', args=[d.arg(name='location', type=d.T.string)]),
      withLocation(location): { location: location },
      '#withMonths':: d.fn(help='"The months of the year in either numerical or the full calendar month.\\nFor example: 1, may."', args=[d.arg(name='months', type=d.T.array)]),
      withMonths(months): { months: if std.isArray(v=months) then months else [months] },
      '#withMonthsMixin':: d.fn(help='"The months of the year in either numerical or the full calendar month.\\nFor example: 1, may."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='months', type=d.T.array)]),
      withMonthsMixin(months): { months+: if std.isArray(v=months) then months else [months] },
      '#withTimes':: d.fn(help='"The time inclusive of the start and exclusive of the end time (in UTC if no location has been selected, otherwise local time)."', args=[d.arg(name='times', type=d.T.array)]),
      withTimes(times): { times: if std.isArray(v=times) then times else [times] },
      '#withTimesMixin':: d.fn(help='"The time inclusive of the start and exclusive of the end time (in UTC if no location has been selected, otherwise local time)."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='times', type=d.T.array)]),
      withTimesMixin(times): { times+: if std.isArray(v=times) then times else [times] },
      '#withWeekdays':: d.fn(help='"The day or range of days of the week.\\nFor example: monday, thursday"', args=[d.arg(name='weekdays', type=d.T.array)]),
      withWeekdays(weekdays): { weekdays: if std.isArray(v=weekdays) then weekdays else [weekdays] },
      '#withWeekdaysMixin':: d.fn(help='"The day or range of days of the week.\\nFor example: monday, thursday"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='weekdays', type=d.T.array)]),
      withWeekdaysMixin(weekdays): { weekdays+: if std.isArray(v=weekdays) then weekdays else [weekdays] },
      '#withYears':: d.fn(help='"The year or years for the interval.\\nFor example: 2021"', args=[d.arg(name='years', type=d.T.array)]),
      withYears(years): { years: if std.isArray(v=years) then years else [years] },
      '#withYearsMixin':: d.fn(help='"The year or years for the interval.\\nFor example: 2021"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='years', type=d.T.array)]),
    ...
    '#withEditable':: d.fn(help='"Whether to enable or disable editing of the mute timing in Grafana UI"', args=[d.arg(name='editable', type=d.T.boolean)]),
    withEditable(editable): { spec+: { editable: editable } },
    '#withName':: d.fn(help='"A unique name for the mute timing"', args=[d.arg(name='name', type=d.T.string)]),
    ...
    '#withTime_intervals':: d.fn(help='"Time intervals for muting"', args=[d.arg(name='time_intervals', type=d.T.array)]),
